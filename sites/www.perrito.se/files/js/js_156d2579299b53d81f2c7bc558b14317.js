...
;
Drupal.behaviors.perritoComments = function (context) {
  $("#comments .box .content").hide();
  $("#comments .box h2.title").click( function() { 
    $("#comments .box .content").slideToggle();
  } );
  $("#comments .box h2.title").css("cursor", "pointer");
  $("#comments .box h2.title").text($("#comments .box h2.title").text() + ' >');
};
;
